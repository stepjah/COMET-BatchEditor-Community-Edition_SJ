...
We would like to start with saying thank you for wanting to contribute to CDP4-BatchEditor codebase. We want to keep it as easy as possible to contribute changes that get things working in your environment. There are a few guidelines that we need contributors to follow so that we have a chance of keeping on top of things.
...
1. Configure the upstream repo (`git remote add upstream git://github.com/RHEAGROUP/CDP4-BatchEditor-Community-Edition`) 
...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical CDP4-BatchEditor version) may be updated. If this happens you should:
...
And remember; **A pull-request with tests is a pull-request that's likely to be pulled in.** :grin: Bonus points if you document your feature in our [wiki](https://github.com/RHEAGROUP/CDP4-BatchEditor-Community-Edition/wiki) once it has been pulled in
