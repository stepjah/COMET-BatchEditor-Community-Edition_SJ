...
namespace CDPBatchEditor.Commands.Command
{
    ...
    /// <summary>
    /// Provides actions that are <see cref="CDP4Common.EngineeringModelData.PossibleFiniteState"/> and <see cref="CDP4Common.EngineeringModelData.ActualFiniteState"/> related
    /// </summary>
