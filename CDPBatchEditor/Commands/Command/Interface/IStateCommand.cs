...
{
    /// <summary>
    /// Defines an <see cref="IStateCommand"/> that Provides actions that are <see cref="CDP4Common.EngineeringModelData.PossibleFiniteState"/> and <see cref="CDP4Common.EngineeringModelData.ActualFiniteState"/> related
    /// </summary>
    public interface IStateCommand
    {
        /// <summary>
        /// Apply option dependence or remove it to/from selected parameters and overrides for element definitions and usages of selected categories.
        /// </summary>
